...
import { getMapRestaurants, getSiteStats } from '../data'
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="mb-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm text-mcd-charcoal/70 sm:text-base">
            {stats.restaurantCount} McDonald&apos;s locations with{' '}
            {stats.reviewCount} curated 1-star reviews. Tap a pin to read the
            misery.
          </p>
        </div>
